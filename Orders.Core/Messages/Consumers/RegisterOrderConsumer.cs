namespace Orders.Core.Messages.Consumers
{
    ...
    public class RegisterOrderConsumer : IConsumer<RegisterOrder>
    {
        ...
        public RegisterOrderConsumer(IOrderRepository orderRepository,
                                            IHttpClientFactory httpClientFactory,
                                            ILogger<RegisterOrderConsumer> logger,
        ...
        public async Task Consume(ConsumeContext<RegisterOrder> context)
        {
            try
            {
                ...
                await context.Publish<SendOrderToUserEmail>(new 
                { 
                    OrderId = orderId,
        ...
        private Order SaveOrder(RegisterOrder result)
        {
            var order = new Order
            {
